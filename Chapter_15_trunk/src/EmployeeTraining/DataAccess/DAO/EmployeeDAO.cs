    ...
    public class EmployeeDAO : BaseDAO {
        ...
        public List<EmployeeVO> SelectAllEmployees() {
            ...
            try {
                ...
                while (reader.Read()) {
                    list.Add(FillInEmployeeVO(reader, trainingDAO));
                }
            }
            catch (Exception e) {
        ...
        public EmployeeVO SelectEmployee(int id) {
            ...
            try {
                ...
                reader = Database.ExecuteReader(command);
                if (reader.Read()) {
                    vo = FillInEmployeeVO(reader, trainingDAO);
                }
                else {
        ...
        public EmployeeVO InsertEmployee(EmployeeVO vo) {
            ...
            try {
                ...
                employeeID = Convert.ToInt32(Database.ExecuteScalar(command));
            }
            catch (Exception e) {
            ...
            return SelectEmployee(employeeID);
        }
        ...
        public EmployeeVO UpdateEmployee(EmployeeVO vo) {
            ...
            return SelectEmployee(vo.EmployeeID);
        }
